...
{!!Form::open(['route' => 'notificationsConfigStore','files'=>true])!!}
<div class="row-fluid">

  <div class="col-md-6">
        <div class="form-group">
          {!!Form::label('Broadcaster')!!}
          {!! Form::select('broadcaster_id', [""=>"Select"]+$broadcasters->lists('display_name','id')->all(), null, array('class' => 'form-control','id'=>'broadcasterSelect')) !!}
        </div>
  </div>
